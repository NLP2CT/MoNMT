...
@register_task("translation_from_pretrained_bart_with_reencoder_task")
class TranslationFromPretrainedBARTwithReencoderTask(TranslationFromPretrainedBARTTask):
