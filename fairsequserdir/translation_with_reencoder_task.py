...
from .my_translation_task import myTranslationConfig, myTranslationTask


logger = logging.getLogger(__name__)

@dataclass
class TranslationWithReencoderConfig(myTranslationConfig):
    pass
    ...
    #     default="",
    #     metadata={
    #         "help": "languages in this model, e.g. ar,de,en"
    #     },
    # )


@register_task("translation_with_reencoder_task", dataclass=TranslationWithReencoderConfig)
class TranslationWithReencoderTask(myTranslationTask):

    def __init__(self, cfg: TranslationWithReencoderConfig, src_dict, tgt_dict):
    ...
    def build_model(self, cfg):
        # cfg.share_all_embeddings=False
        # cfg.load_pretrained_reencoder_from=None
        # cfg.keep_inference_langtok=False
