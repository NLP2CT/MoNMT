...
class myEncoder(TransformerEncoder):
    ...
    def forward(
        ...
        reencoder_insert_layer: int = None,
        reencoder = None,
    ):
        """
        Args:
        ...
        for i, layer in enumerate(self.layers):
            ...
            if reencoder_insert_layer is not None and reencoder is not None:
                if i + 1 == reencoder_insert_layer:
                    reencoder_out = reencoder(x, encoder_padding_mask, insert=True)
                    x = reencoder_out["encoder_out"][0]
...
@register_model("reencoder_transformer_2")
class ReEncoderTransformer2(TransformerModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument("--reencoder-insert-layer", type=int, metavar="N", default=None,
                            help="which encoder layer the output to the reencoder layer")
    ...
    def __init__(self, args, encoder, decoder):
        ...
        self.reencoder_insert_layer=args.reencoder_insert_layer
    ...
    def build_encoder(cls, args, src_dict, embed_tokens):
        encoder = myEncoder(args, src_dict, embed_tokens)
    ...
    def forward(
        ...
        encoder_out = self.encoder(
            ...
            reencoder_insert_layer=self.reencoder_insert_layer, reencoder=self.reencoder
        )
...
@register_model_architecture("reencoder_transformer_2", "reencoder_transformer_2_base")
def modular_base_architecture(args):
    ...
    args.reencoder_insert_layer = getattr(args, "reencoder_insert_layer", args.encoder_layers)
    


@register_model_architecture("reencoder_transformer_2", "reencoder_transformer_2_big")
