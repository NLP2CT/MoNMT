...
@register_model("mlm_lm_selfatt_transformer_model")
...
class BridgeTransformerDecoder(TransformerDecoder):
    ...
    def extract_features_scriptable(
        ...
        x_dim = prev_output_tokens.size(1)
        # embed positions
        positions = (
...
@register_model_architecture("mlm_lm_selfatt_transformer_model", "mlm_lm_selfatt_transformer_base")
...
@register_model_architecture("mlm_lm_selfatt_transformer_model", "mlm_lm_selfatt_transformer_iwslt_de_en")
...
@register_model_architecture("mlm_lm_selfatt_transformer_model", "mlm_lm_selfatt_transformer_wmt_en_de")
