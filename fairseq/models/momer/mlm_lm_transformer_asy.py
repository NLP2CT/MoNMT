...
@register_model("asy_mlm_lm_transformer_model")
class asyMLMLMTransformerModel(TransformerModel):
    """
...
@register_model_architecture("asy_mlm_lm_transformer_model", "asy_mlm_lm_transformer")
...
@register_model_architecture("mlm_lm_transformer_model", "asy_mlm_lm_transformer_iwslt_de_en")
...
@register_model_architecture("mlm_lm_transformer_model", "asy_mlm_lm_transformer_wmt_en_de")
def mlm_lm_transformer_wmt_en_de(args):
    base_mlm_lm_transformer(args)


@register_model_architecture("mlm_lm_transformer_model", "asy_mlm_lm_transformer_vaswani_wmt_en_de_big")
