...
@register_model("mlm_lm_transformer_model")
class MLMLMTransformerModel(TransformerModel):
    """
...
class CLMTransformerDecoder(TransformerDecoder):
    """
...
@register_model_architecture("mlm_lm_transformer_model", "mlm_lm_transformer")
...
@register_model_architecture("mlm_lm_transformer_model", "mlm_lm_transformer_iwslt_de_en")
...
@register_model_architecture("mlm_lm_transformer_model", "mlm_lm_transformer_wmt_en_de")
def mlm_lm_transformer_wmt_en_de(args):
    base_mlm_lm_transformer(args)


@register_model_architecture("mlm_lm_transformer_model", "mlm_lm_transformer_vaswani_wmt_en_de_big")
...
@register_model_architecture("mlm_lm_transformer_model", "mlm_lm_transformer_tiny")
def mlm_lm_transformer_tiny(args):
...
@register_model_architecture("mlm_lm_transformer_model", "mlm_lm_transformer_mbart")
def mlm_lm_transformer_iwslt_de_en(args):
