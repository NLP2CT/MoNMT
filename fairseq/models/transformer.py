...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def extract_features_scriptable(
        ...
        # avg layer for alignment
        #         else None,
        #         incremental_state,
        #         self_attn_mask=self_attn_mask,
        #         self_attn_padding_mask=self_attn_padding_mask,
        #         need_attn=bool(alignment_layer!=None),
        #         need_head_weights=bool((idx == alignment_layer)),
        #     )
        #     #need_attn=bool((idx == alignment_layer)),
        #     inner_states.append(x)
        #     # if layer_attn is not None and idx == alignment_layer:
        #     #     attn = layer_attn.float().to(x)
        #     if layer_attn is not None and attn == None:
        #         attn = layer_attn.float().to(x)
        #     if layer_attn is not None and attn != None:
        #         attn = (attn + layer_attn.float()).to(x)
        #         pass
...
@register_model_architecture("transformer", "transformer_wmt_en_de_base_sca")
def transformer_wmt_en_de_base_sca(args):
