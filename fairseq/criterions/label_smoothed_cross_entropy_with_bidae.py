...
@dataclass
class LabelSmoothedCrossEntropyWithBiDAEConfig(FairseqDataclass):
...
@register_criterion(
    "label_smoothed_cross_entropy_with_bidae", dataclass=LabelSmoothedCrossEntropyWithBiDAEConfig
)
class LabelSmoothedCrossEntropyWithBiCriterion(FairseqCriterion):
    def __init__(
        self,
        task,
        sentence_avg,
    ...
    def forward(self, model, sample, reduce=True, mode='mt'):
        ...
        """
        assert mode in ['mt', 'mlm', 'lm', 'dae', 'srcdae', 'tgtdae']
