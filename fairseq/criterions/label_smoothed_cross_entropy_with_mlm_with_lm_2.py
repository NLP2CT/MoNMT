...
@register_criterion(
    "label_smoothed_cross_entropy_with_mlm_with_lm_2", dataclass=LabelSmoothedCrossEntropyWithMLMWithLMCriterionConfig2
)
class LabelSmoothedCrossEntropyWithMLMWithLMCriterion2(FairseqCriterion):
    def __init__(
        self,
        task,
        sentence_avg,
