...
@dataclass
class UnifiedMultiTaskTranslationConfig(FairseqDataclass):
    ...
    srcdae_freeze: bool = field(
        default=False, metadata={"help": "prepend beginning of sentence token (<s>)"}
    )
    
    tgtdae_freeze: bool = field(
        default=False, metadata={"help": "prepend beginning of sentence token (<s>)"}
    )



@register_task("unified_multitask_translation", dataclass=UnifiedMultiTaskTranslationConfig)
class UnifiedMultitaskTranslationTask(FairseqTask):
    """
    ...
    cfg: UnifiedMultiTaskTranslationConfig

    def __init__(self, cfg: UnifiedMultiTaskTranslationConfig, src_dict, tgt_dict, lm_targets=None):
        super().__init__(cfg)
        ...
        self.srcdae_freeze = cfg.srcdae_freeze
        self.tgtdae_freeze = cfg.tgtdae_freeze
    ...
    @classmethod
    def setup_task(cls, cfg: UnifiedMultiTaskTranslationConfig, **kwargs):
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        if (
            ...
            bt_path=os.path.join(data_path, self.cfg.monopath, "backtranslation_output", tgt+"2"+src)
