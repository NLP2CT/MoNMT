...
class SentencePredictionTask(LegacyFairseqTask):
    ...
    def load_dictionary(cls, args, filename, source=True):
        ...
        # to be delete
        dictionary.add_symbol("[{}]".format('en'))
        dictionary.add_symbol("[{}]".format('de'))
        # to be delete
        return dictionary
    ...
    def load_dataset(self, split, combine=False, **kwargs):
        ...
        if self.args.append_lg_token is not None:
            input0 = AppendTokenDataset(input0, self.args.append_lg_token)
