...
@register_task("multitasktranslation5", dataclass=MultiTaskTranslationConfig)
class MultitaskTranslationTask5(FairseqTask):
    """
    ...
    def load_dataset(self, split, epoch=1, combine=False, **kwargs):
        ...
        if (
            ...
            bt_path=os.path.join(data_path, args.monopath, "backtranslation_output", tgt+"2"+src)
        ...
        if (
            ...
            ft_path=os.path.join(data_path, args.monopath, "backtranslation_output", src+"2"+tgt)
    ...
    def train_step(self, sample, model, criterion, optimizer, update_num, ignore_grad=False
        ...
        if self.lambda_tgtdae > 0.0:
            forward_backward(model, sample['tgtdae'], 'tgtdae', self.lambda_srcdae, 'tgtdae')
