...
@register_task("my_crn_translation_multi_simple_epoch")
class myCRNTranslationMultiSimpleEpochTask(LegacyFairseqTask):
    """
...
# if not getattr(args, "crossatt", False) and getattr(args, "num_lm_layers", False) and getattr(args, "cross_self_attention", False):
