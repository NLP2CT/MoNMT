...
class MultiTaskTranslationConfig(FairseqDataclass):
    ...
    langs: str = field(
        default=LANGS, metadata={"help": "mbart langs"}
    )



@register_task("multitasktranslationallmbart", dataclass=MultiTaskTranslationConfig)
class MultitaskTranslationTaskAllmBart(FairseqTask):
    """
